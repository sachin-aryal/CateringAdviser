<div class="row">
    ...
    <div class="form-group col-md-4">
        ...
        <input type="text" name="openingTime" id="openingTime" placeholder="Opening Time" class="form-control"/>
    </div>
    <div class="form-group col-md-4">
        <label for="closingTime">Closing Time</label>
        <input type="text" name="closingTime" id="closingTime" placeholder="Closing Time" class="form-control"/>
    </div>
    <div class="form-group col-md-4">
        <label for="musicEnd">Music End</label>
        <input type="text" name="musicEnd" id="musicEnd" placeholder="Music End" class="form-control"/>
    </div>
</div>
<div class="row">
    <div class="form-group col-md-4">
        <label for="indoorSize">Indoor Size</label>
        <input type="text" name="indoorSize" id="indoorSize" placeholder="Indoor Size" class="form-control"/>
    </div>
    <div class="form-group col-md-4">
        <label for="iMaxCapacity">Max Pax Capacity</label>
        <input type="text" name="iMaxCapacity" id="iMaxCapacity" placeholder="Max Pax Capacity" class="form-control"/>
    </div>
</div>
<div class="row">
    <div class="form-group col-md-4">
        <label for="outdoorSize">Outdoor Size</label>
        <input type="text" name="outdoorSize" id="outdoorSize" placeholder="Outdoor Size" class="form-control"/>
    </div>
    <div class="form-group col-md-4">
        <label for="oMaxCapacity">Max Pax Capacity</label>
        <input type="text" name="oMaxCapacity" id="oMaxCapacity" placeholder="Max Pax Capacity" class="form-control"/>
    </div>
</div>
<div class="row">
    <div class="form-group col-md-4">
        <label for="venueSize">Venue Size</label>
        <input type="text" name="venueSize" id="venueSize" placeholder="Venue Size" class="form-control"/>
    </div>
    <div class="form-group col-md-4">
        <label for="noOfHall">No of Hall</label>
        <input type="number" name="noOfHall" id="noOfHall" placeholder="No of Hall" class="form-control"/>
    </div>
</div>
<div class="row">
    ...
    <div class="form-group col-md-4">
        ...
        <input type="text" name="parkingSize" id="parkingSize" placeholder="Parking Size" class="form-control"/>
    </div>
</div>
<br>
<div class="row">
...
<div class="row">
    <div class="form-group col-md-4">
        ...
        <input type="number" name="noOfServers" id="noOfServers" placeholder="No of Servers" class="form-control"/>
    </div>
    <div class="form-group col-md-4">
        <label for="noOfBar">No of Bar</label>
        <input type="number" name="noOfBar" id="noOfBar" placeholder="No of Bar" class="form-control"/>
    </div>
    <div class="form-group col-md-4">
        <label for="noOfHelpers">No of Helpers</label>
        <input type="number" name="noOfHelpers" id="noOfHelpers" placeholder="No of Helpers" class="form-control"/>
    </div>
</div>
<div class="row">
    <div class="form-group col-md-4">
        <label for="noOfCooks">No of Cooks</label>
        <input type="number" name="noOfCooks" id="noOfCooks" placeholder="No of Cooks" class="form-control"/>
    </div>
    <div class="form-group col-md-4">
        <label for="noOfCleaners">No of Cleaners</label>
        <input type="number" name="noOfCleaners" id="noOfCleaners" placeholder="No of Cleaners" class="form-control"/>
    </div>
    <div class="form-group col-md-4">
        <label for="noOfOthers">No of Others</label>
        <input type="number" name="noOfOthers" id="noOfOthers" placeholder="No of Others" class="form-control"/>
    </div>
</div>
<div class="row">
    <div class="form-group col-md-4">
        <label for="noOfGuards">No of Guards</label>
        <input type="number" name="noOfGuards" id="noOfGuards" placeholder="No of Guards" class="form-control"/>
    </div>
</div>
